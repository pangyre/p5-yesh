...
The feed for the user. Yesh will only support Atom feeds.

=back

=head3 Yesh::Controller::Session

=over 4

=item /login

Sign-in. Can be forced to B<https> with L<configuration settings|/CONFIGURATION>.

=back

=head3 Yesh::Controller::Article
